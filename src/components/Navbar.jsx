...
const Navbar = () => {
  ...
  return (
    <div className='h-full flex items-center justify-between px-4 sm:px-8 lg:px-20 xl:px-48 text-xl'>
      {/* links */}
      ...
      {/* logo */}
      <div className='md:hidden lg:flex  gap-4 w-1/3 xl:justify-center'>
        <Link
          href='/'
